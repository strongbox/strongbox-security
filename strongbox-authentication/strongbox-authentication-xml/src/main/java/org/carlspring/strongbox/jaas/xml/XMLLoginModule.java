        ...
        extends BaseLoginModule
{
    ...
    private static Logger logger = LoggerFactory.getLogger(XMLLoginModule.class);

    private UserResolver userResolver = new XMLUserRealm();
                           ...
                           Map<String, ?> options)
    {
        ...
        logger.debug("XMLLoginModule initialized!");
    }
