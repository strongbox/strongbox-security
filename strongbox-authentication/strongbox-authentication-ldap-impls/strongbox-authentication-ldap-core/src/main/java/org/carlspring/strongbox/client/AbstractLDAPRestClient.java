 ...
 * @author mtodorov
 */
public abstract class AbstractLDAPRestClient
        extends RestClient
{
    ...
    public int setLdapPort(int port)
    {
        ...
        WebTarget resource = client.target(getConfigurationBaseUrl() + "/port/" + port);
    ...
    public int getLdapPort()
    {
        ...
        WebTarget resource = client.target(getConfigurationBaseUrl() + "/port");
     ...
     * @return
     */
    public abstract String getConfigurationBaseUrl();
